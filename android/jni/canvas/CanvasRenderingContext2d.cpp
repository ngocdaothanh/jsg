...
void
Context2d::Initialize(Handle<ObjectTemplate> target) {
  HandleScope scope;
  ...
  target->Set(String::NewSymbol("CanvasRenderingContext2d"), constructor);
}
...
Context2d::SetFont(const Arguments &args) {
  ...
  cairo_font_face_t* font_face = FontFace::get(*family);
  if (font_face) {
