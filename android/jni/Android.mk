...
LOCAL_LDLIBS    := -lm -llog -landroid -ljnigraphics -lEGL -lGLESv2 -lz -Ljni/v8 -lv8

LOCAL_SRC_FILES := $(NODE_SRC) $(CANVAS_SRC) $(JSG_SRC)
LOCAL_STATIC_LIBRARIES := libpng libpixman libcairo libfreetype2 cpufeatures android_native_app_glue
